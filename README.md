            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="./index.html"><h2>Blink Buy</h2></a>
                    </div>
                </div>
                            ...
                            <div class="checkout__order">
                                ...
                                <div class="checkout_input_checkbox">
                                    <label for="paypal">
                                     ...
                                     <div class="button">
                                        <button type="button" onclick="window.location.href='thank.html'" class="btn btn-primary">Place Order</button>
                                     </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 text-center">
                    <div class="footer_copyright_text">
                        ...
                        <p>Copyright ©
                            ...
                            aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Zeyan</a>
                        </p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
